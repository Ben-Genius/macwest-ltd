  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden bg-white flex items-center">
        <Container className="relative z-10 py-36 lg:py-0 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center min-h-screen lg:min-h-0 lg:py-10">

            {/* ── Left: text ── */}
            <div>
              <Reveal variants={fadeInUp} className="mb-7">
                <Link
                  href="/services"
              ...
              <GSAPStaggerText
                text="Softworks & Augmented Services."
                className="font-display text-4xl sm:text-6xl lg:text-[4.5rem] font-bold text-navy-900 leading-tight tracking-tight mb-8"
                y={40}
                stagger={0.04}
              />

              <Reveal variants={fadeInUp}>
                <p className="text-navy-500 text-base sm:text-lg leading-relaxed max-w-[42ch] mb-10">
                  Beyond physical infrastructure, Macwest builds human capacity and community resilience through vocational training, health education, and facilitated stakeholder dialogues.
                </p>
              </Reveal>
              ...
              >
                {["Vocational Training", "Argon Welding", "Health Education", "Stakeholder Engagement"].map((tag) => (
                  <m.span
                    key={tag}
                    variants={scaleIn}
                    className="px-3.5 py-1.5 rounded-full border border-navy-200 bg-navy-50 text-[11px] font-bold uppercase tracking-widest text-navy-600"
                  >
                    {tag}
                  </m.span>
                ))}
            ...
            {/* ── Right: staggered gallery grid ── */}
            <m.div
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              transition={{ staggerChildren: 0.18, delayChildren: 0.25 }}
              className="grid grid-cols-2 gap-4 h-[520px] sm:h-[600px] lg:h-[640px]"
              style={{ gridTemplateRows: "65px 200px 65px 200px 65px" }}
            >
              {[
                {
                  src: "https://i0.wp.com/macwest.com.gh/wp-content/uploads/2025/03/0T6A5768-scaled.jpg",
                  alt: "Sanitary Pads Training",
                  gridArea: "col-start-2 col-end-3 row-start-1 row-end-3",
                },
                {
                  src: "https://i0.wp.com/macwest.com.gh/wp-content/uploads/2025/03/0T6A0271.jpg",
                  alt: "Argon Welding Training",
                  gridArea: "col-start-1 col-end-2 row-start-2 row-end-4",
                },
                {
                  src: "https://i0.wp.com/macwest.com.gh/wp-content/uploads/2025/03/0T6A9000-scaled.jpg",
                  alt: "Health Training",
                  gridArea: "col-start-1 col-end-2 row-start-4 row-end-6",
                },
                {
                  src: "https://i0.wp.com/macwest.com.gh/wp-content/uploads/2025/03/0T6A0171-scaled.jpg",
                  alt: "Stakeholder Engagements",
                  gridArea: "col-start-2 col-end-3 row-start-3 row-end-5",
                },
              ].map((img, i) => (
                <m.div
                  key={img.alt}
                  ...
                  className={`relative overflow-hidden rounded-2xl shadow-2xl ${img.gridArea}`}
                >
                  <Image
                    src={img.src}
                    alt={img.alt}
                    ...
                    sizes="(max-width: 124px) 50vw, 30vw"
                    priority={i < 2}
                  />
